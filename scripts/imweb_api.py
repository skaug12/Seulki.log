...
class ImwebAPI:
    ...
    def update_product(self, product_code: str, data: Dict) -> Dict:
        """
        상품 정보 수정

        Args:
            product_code: 상품 코드 (no 필드)
            data: 수정할 상품 데이터
                - name: 상품명
                - content: 상품 상세 설명 (HTML)
                - simple_content: 상품 간략 설명 (HTML)
                - price: 가격
                - prod_status: 상품 상태 (sale, soldout, nosale)
                - 기타 필드...
        ...
        try:
            ...
            if result.get("code") == 200:
                print(f"✅ 상품 수정 성공: {product_code}")
            else:
                print(f"⚠️ 상품 수정 응답: {result}")
    ...
    def create_product(self, data: Dict) -> Dict:
        ...
        try:
            ...
            try:
                ...
                pass
            print(f"❌ 상품 등록 실패: {error_detail}")
            return {"error": error_detail}

    def delete_product(self, product_code: str) -> Dict:
        """
        상품 삭제
        ...
        try:
            ...
            if result.get("code") == 200:
                print(f"✅ 상품 삭제 성공: {product_code}")
            else:
                print(f"⚠️ 상품 삭제 응답: {result}")
